...
# st.set_page_config(page_title="InterviewPilot", page_icon="I", layout="wide")
...
# iframe[title="streamlit_mic_recorder"] { height: 48px !important; border: none !important; background: transparent !important; }
...
#                             with rc1:
#                                 audio = mic_recorder(start_prompt="Start Recording", stop_prompt="Stop Recording", key="mic_practice")
#                             with rc2:
...
#                         rc1, rc2 = st.columns([0.65, 2.35])
#                         with rc1:
#                             audio = mic_recorder(start_prompt="Start Recording", stop_prompt="Stop Recording", key=f"mock_mic_{curr}")
#                         with rc2:
